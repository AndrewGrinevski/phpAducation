                    ...
                    <div class="header__actions"><a href="#">Login & Regiser</a>
                        <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD<i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><img src="/shop_assets/images/flag/usa.svg" alt=""> USD</a></li>
                                <li><a href="#"><img src="/shop_assets/images/flag/singapore.svg" alt=""> SGD</a></li>
                                <li><a href="#"><img src="/shop_assets/images/flag/japan.svg" alt=""> JPN</a></li>
                            </ul>
                        </div>
    ...
    <nav class="navigation">
        <div class="container-fluid">
            <div class="navigation__column left">
                <div class="header__logo"><a class="ps-logo" href="index.html"><img src="/shop_assets/images/logo.png" alt=""></a></div>
            </div>
                        ...
                        <div class="mega-menu">
                            <div class="mega-wrap">
                                ...
                                <div class="mega-column">
                                    ...
                                    <ul class="mega-item">
                                        <li><a href="/?page_type=clothing&id=1">View all</a></li>
                                        <li><a href="/?page_type=clothing&id=11">Running</a></li>
                                        <li><a href="/?page_type=clothing&id=8">Boots</a></li>
                                        <li><a href="/?page_type=clothing&id=7">Sandals</a></li>
                                        <li><a href="/?page_type=clothing&id=6">Shoes</a></li>
                                        <li><a href="/?page_type=clothing&id=5">Slippers</a></li>
                                    </ul>
                                </div>
                                <div class="mega-column">
                                    <h4 class="mega-heading">CLOTHING</h4>
                                    <ul class="mega-item">
                                        <li><a href="/?page_type=clothing&id=2">View all</a></li>
                                        <li><a href="/?page_type=clothing&id=16">Designer</a></li>
                                        <li><a href="/?page_type=clothing&id=17">Hoodies & Sweatshirts</a></li>
                                        <li><a href="/?page_type=clothing&id=18">Jackets & Coats</a></li>
                                        <li><a href="/?page_type=clothing&id=19">Jeans</a></li>
                                        <li><a href="/?page_type=clothing&id=20">Polo shirts</a></li>
                                    </ul>
                                </div>
                                <div class="mega-column">
                                    <h4 class="mega-heading">Accessories</h4>
                                    <ul class="mega-item">
                                        <li><a href="/?page_type=clothing&id=3">View all</a></li>
                                        <li><a href="/?page_type=clothing&id=21">Sunglasses</a></li>
                                        <li><a href="/?page_type=clothing&id=22">Watches</a></li>
                                        <li><a href="/?page_type=clothing&id=23">Caps & Hats</a></li>
                                        <li><a href="/?page_type=clothing&id=24">Belts</a></li>
                                        <li><a href="/?page_type=clothing&id=25">Face coverings</a></li>
                                    </ul>
                                </div>
                                <div class="mega-column">
                                    <h4 class="mega-heading">Sportswear</h4>
                                    <ul class="mega-item">
                                        <li><a href="/?page_type=clothing&id=4">View all</a></li>
                                        <li><a href="/?page_type=clothing&id=26">Accessories</a></li>
                                        <li><a href="/?page_type=clothing&id=27">Hoodies</a></li>
                                        <li><a href="/?page_type=clothing&id=28">Shorts</a></li>
                                        <li><a href="/?page_type=clothing&id=29">Joggers</a></li>
                                        <li><a href="/?page_type=clothing&id=30">Tops</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ps-cart__listing">
                        <div class="ps-cart__content">
                            <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                                <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="/shop_assets/images/cart-preview/1.jpg" alt=""></div>
                                <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">Amazin’ Glazin’</a>
                                    <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                                </div>
                            </div>
                            <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                                <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="/shop_assets/images/cart-preview/2.jpg" alt=""></div>
                                <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">The Crusty Croissant</a>
                                    <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                                </div>
                            </div>
                            <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                                <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="/shop_assets/images/cart-preview/3.jpg" alt=""></div>
