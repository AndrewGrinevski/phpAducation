            ...
            <div class="pull-right">
                ...
                <div class="btn-group btn-group-option">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="/admin/?action=destroy_session"><i class="glyphicon glyphicon-log-out"></i>Sign Out</a></li>
                    </ul>
                </div><!-- btn-group -->
    ...
    <div class="mainwrapper">
        <div class="leftpanel">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="parent"><a href="/admin/?action=add_page"><i class="fa fa-edit"></i> <span>Shop</span></a>
                    <ul class="children">
                        <li><a href="/admin/?action=shop_polo_shirts&id=1"">Shoes</a></li>
                        <li><a href="/admin/?action=shop_polo_shirts&id=2"">Shorts</a></li>
                        <li><a href="/admin/?action=shop_polo_shirts&id=3"">Jackets</a></li>
                        <li><a href="/admin/?action=shop_polo_shirts&id=4"">Gym Clothes</a></li>
                        <li><a href="/admin/?action=shop_polo_shirts&id=5">Accessories</a></li>
                        <li><a href="/admin/?action=shop_polo_shirts&id=6">Tops</a></li>
                        <li><a href="/admin/?action=shop_polo_shirts&id=7">Golf</a></li>
                        <li><a href="/admin/?action=shop_polo_shirts&id=8">Running</a></li>
                    </ul>
                </li>
